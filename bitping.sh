...
# 确认
input_status(){
  [ -z $TMTOKEN ] && reading "Do you have a account and remember the account's emalis with passwords ? (Y/N)\n If you do not have a account, open https://app.bitping.com/?r=YIwAx_jx : " STATUS
}
